...
<body class="bg-gray-100">
    ...
    <main>
        ...
        <section class="py-16 bg-white">
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<table>
                <tr>
                    <td><img id="img1" src="01.jpg" alt="1"></td>
                    <td><img id="img2" src="02.jpg" alt="2"></td> 
                    <td><img id="img3" src="03.jpg" alt="3"></td>
                    <td><img id="img4" src="04.jpg" alt="4"></td>
                    <td><img id="img5" src="06.jpg" alt="5"></td>
                    <td><img id="img6" src="bgimg.jpg" alt="6"></td>
                </tr>
            </table>
             </div>
        </section>
